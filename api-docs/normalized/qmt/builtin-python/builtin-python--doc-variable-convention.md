...
source_anchor: "#doc-variable_convention"
...
<a id="doc-variable_convention"></a>

# 3\. 变量约定

<a id="variable_convention--函数命名规则"></a>
...
<a id="variable_convention--账号类型说明"></a>
...
<a id="variable_convention--symbol-code-代码表示"></a>
...
<a id="variable_convention--交易所代码"></a>
...
迅投研系统目前支持一站式获取全球多市场数据，详情链接：[全球市场数据在新窗口打开](https://xuntou.net/#%2FshoppingMall%3Fgoback%3D1%26id%3D7zqjlm)
...
<a id="variable_convention--交易标的代码"></a>
...
<a id="variable_convention--symbol示例"></a>
...
<a id="variable_convention--期货主力连续合约"></a>
...
<a id="variable_convention--期货加权连续合约"></a>
...
<a id="variable_convention--mode-模式选择"></a>

## mode - 模式选择

迅投研终端中，策略可以以四种模式运行，分别为`调试运行模式`，`回测模式`,`模拟信号模式`,`实盘交易模式`，模式需要在运行策略时手动选择

<a id="variable_convention--调试运行模式"></a>
...
<a id="variable_convention--回测模式"></a>
...
<a id="variable_convention--模拟信号模式"></a>
...
<a id="variable_convention--实盘交易模式"></a>
...
<a id="variable_convention--contextinfo-上下文对象"></a>

## ContextInfo - 上下文对象

<a id="variable_convention--contextinfo-start-contextinfo-end-回测开始-结束时间"></a>
...
<a id="variable_convention--contextinfo-capital-设定回测初始资金"></a>
...
<a id="variable_convention--contextinfo-period-获取当前周期"></a>
...
<a id="variable_convention--contextinfo-barpos-获取当前运行到-k-线索引号"></a>
...
<a id="variable_convention--contextinfo-time-tick-size-获取当前图-k-线数目"></a>
...
<a id="variable_convention--contextinfo-stockcode-获取当前图代码"></a>
...
<a id="variable_convention--contextinfo-market-获取当前主图市场"></a>
...
<a id="variable_convention--contextinfo-dividend-type-获取当前主图复权处理方式"></a>
...
<a id="variable_convention--contextinfo-benchmark-获取回测基准标的"></a>
...
<a id="variable_convention--contextinfo-do-back-test-表示当前是否为回测模式"></a>
