...
查询股票的**市值数据、资产负债数据、现金流数据、利润数据、财务指标数据**. 详情通过[财务数据列表](#财务数据列表)查看! 可通过以下api进行查询 :
...
查询财务数据，详细的财务数据表及字段描述请点击[财务数据文档](#获取单季度年度财务数据)查看，Query 对象的使用方法请参考[Query的简单教程](https://www.joinquant.com/view/community/detail/433d0e9ed9fed11fc9f7772eab8d9376)
...
查询多日财务数据，详细的财务数据表及字段描述请点击[财务数据文档](#获取单季度年度财务数据)查看，Query 对象的使用方法请参考[Query的简单教程](https://www.joinquant.com/view/community/detail/433d0e9ed9fed11fc9f7772eab8d9376)
