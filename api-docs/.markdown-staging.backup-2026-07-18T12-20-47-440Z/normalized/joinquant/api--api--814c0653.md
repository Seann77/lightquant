...
查询财务数据，详细的财务数据表及字段描述请点击[财务数据文档](stock-ccc91371.md#获取单季度年度财务数据)查看，Query 对象的使用方法请参考[Query的简单教程](https://www.joinquant.com/view/community/detail/433d0e9ed9fed11fc9f7772eab8d9376)
...
查询多日财务数据，详细的财务数据表及字段描述请点击[财务数据文档](stock-ccc91371.md#获取单季度年度财务数据)查看，Query 对象的使用方法请参考[Query的简单教程](https://www.joinquant.com/view/community/detail/433d0e9ed9fed11fc9f7772eab8d9376)
...
查询深沪港通、股东信息、公司概况等数据，详细的数据字段描述请点击[市场通（沪港通深港通和港股通）](stock-9c7c1503.md#市场通（沪港通深港通和港股通）)查看
...
获取所有的概念板块列表，行业分类列表见数据页面-[行业概念数据](https://www.joinquant.com/help/api/help?name=faq#plateData%3A%E6%A6%82%E5%BF%B5%E6%9D%BF%E5%9D%97)。
...
-   style: 参见[OrderStyle](https://www.joinquant.com/help/api/help?name=faq#api%3AOrderStyle), None代表MarketOrder
...
更多模拟盘细节, 请看 [模拟盘注意事项](https://www.joinquant.com/help/api/help?name=faq#api%3A%E6%A8%A1%E6%8B%9F%E7%9B%98%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9).
...
-   status: 状态, 一个[OrderStatus](https://www.joinquant.com/help/api/help?name=faq#api%3AOrderStatus)值
...
-   要使用模拟交易发送微信功能, 必须[绑定及开启微信通知](faq-45a6d115.md#如何开启微信通知？)；
-   此功能只能在 **聚宽官网的实时运行模拟交易** 中使用, 回测中使用会直接忽略, 无任何提示；有关[实时和延时运行](faq-45a6d115.md#延时运行)
...
-   [参数优化及并行回测参考教程](faq-45a6d115.md#参数优化及并行回测)
-   [区分create\_backtest(策略ID)和get\_backtest(回测ID)](faq-45a6d115.md#参数优化及并行回测)
