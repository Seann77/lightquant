...
4.  股票指数：我们支持近600种[股票指数](https://www.joinquant.com/data/dict/indexData)数据，包括指数的行情数据以及成分股数据。为了避免未来函数，我们支持获取历史任意时刻的指数成分股信息，具体见[get\_index\_stocks](api--api--814c0653.md#get_index_stocks)和[get\_index\_weights](api--api--814c0653.md#get_index_weights)。注意：指数不能买卖
5.  行业板块：我们支持按行业、按板块选股，具体见[get\_industry\_stocks](api--api--814c0653.md#get_industry_stocks)
6.  概念板块：我们支持按概念板块选股，具体见[get\_concept\_stocks](api--api--814c0653.md#get_concept_stocks)
...
-   回测中可以使用[read\_file](api--api--814c0653.md#read_file)/[write\_file](api--api--814c0653.md#write_file)读写研究模块的文件。
