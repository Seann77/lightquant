...
-   模拟交易是根据回测的策略创建的，因此需要先回测，再创建模拟交易，[如何创建模拟交易？](faq-45a6d115.md#如何进行模拟交易？)
...
回测代码如下, 优化函数API详情见 [portfolio\_optimizer - 投资组合优化](https://www.joinquant.com/help/api/help?name=faq#name%3Aoptimizer)：
